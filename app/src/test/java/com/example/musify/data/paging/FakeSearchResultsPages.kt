...
fun getSearchResultsResponseForFakePageNumber(fakePageNumber: FakeSearchResultsPageNumbers) = SearchResultsResponse(
    ...
    shows = SearchResultsResponse.Shows(emptyList()) // TODO
)
